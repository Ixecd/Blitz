...
blitz 是 BTC/ETH 充提币系统，同时是 dtk 的活体验证环境。两个项目同步开发，blitz 的部署问题直接反哺 dtk。
...
├── deployments/blitz/
│   ├── blitz-postgres/
│   ├── blitz-etcd/    # StatefulSet，PVC 1Gi
...
# 查看日志
kubectl logs -n blitz deployment/wallet-service -f

# 本地调试
kubectl port-forward -n blitz deployment/wallet-service 2113:2113
