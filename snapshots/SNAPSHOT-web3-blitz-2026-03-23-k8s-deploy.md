...
### K8s postgres
- Bitnami postgresql 已装到 `web3-blitz` namespace
...
# 3. dtk deploy
# 4. 验证
kubectl logs -n web3-blitz <wallet-service-pod>
```
...
- deployments/web3-blitz/values.yaml  ← 顶层 env 加 DATABASE_URL（walletService.env 待加）
```
...
└── SNAPSHOT-web3-blitz-2026-03-23-k8s-deploy.md   ← 本次
```
